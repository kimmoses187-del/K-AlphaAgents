...
class DebateGrid:
    ...
    def __init__(self, profiles=None, agents=None):
        ...
        # Keep canonical order; default to all agents.
        chosen = list(agents) if agents else list(_AGENTS)
        self._agents     = [a for a in _AGENTS if a in chosen]
